...
public class AdminUIHandler {
    ...
    public AdminUIHandler(Scanner scanner, UserAuth currentUser,
            UserManagementUIHandler userHandler, ClassManagementUIHandler classHandler,
            MerchandiseUIHandler merchandiseHandler, ReportsUIHandler reportsHandler,
