...
public class MembershipUIHandler {
    ...
    /**
     * Show membership selection flow for new GUEST users
     * Once they select a membership, they become a MEMBER
     */
        ...
        try {
            ...
            if (memberDAO.create(newMember)) {
                ...
                if (authDAO.updateUserRole(user.getUserId(), "MEMBER")) {
                    ...
                    uiHelper.printSuccess("Your membership is now active. You can now access all member features.");
