...
/**
 * Utility class for consistent terminal output formatting with ANSI color codes. Provides methods
 * for printing headers, options, prompts, and status messages.
 */
public class UIHelper {
  ...
  /**
   * Prints a standardized menu header with title and user information. Ensures consistent alignment
   * across all menu handlers.
   */
  public void printMenuHeader(String menuTitle, String username, String role) {
    ...
    System.out.println(
        BRIGHT_YELLOW
            + buildBoxLine("  User: " + username.toUpperCase() + " | Role: " + role.toUpperCase())
            + RESET);
    System.out.println(BRIGHT_CYAN + BOLD + buildBottomBorder() + RESET);
  }

  /**
   * Prints a standardized submenu header without user information. Used for utility menus like
   * Reports, Class Management, etc.
   */
